...
eflector拿到变更事件后，将事件塞入reflector的store中，其实也是controller的Queue，对应到shared_informer中是构造的DeltaFIFO实现

![](./reflector_store.jpg)
![](./controller_queue.jpg)
![](./reflector_queue.jpg)
